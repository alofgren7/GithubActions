[![Run App Andrew Lofgren](https://github.com/alofgren7/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/alofgren7/GithubActions/actions/workflows/run-app.yaml)
